Mines of Moria for PortMaster - what is in the binary and under what terms.

The port ships one executable per architecture and nothing else. SDL2 is NOT
bundled: the binary links against the libSDL2 the device already provides.
